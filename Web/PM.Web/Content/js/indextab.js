(function ($) {
    $.nfinetab = {
        ...
        addTab: function () {
            ...
            var menuName = "";
            if (dataId == "MyApproval" || dataId == "MyMessage" || dataId == "MyEarlyWarning") {
                if ($(this).children().length > 0) {
                    menuName = $.trim($(this).children()[0].innerHTML);
                }
                else {
            ...
            $('.menuTab').each(function () {
                if ($(this).context.text.trim() == menuName) {//表示传递了参数
                    $(this).remove();//移除原来打开的窗口
                    flag = true;
                    return false;
                }
        ...
        syaddtab: function () {
            ...
            if (dataId == "Article") {
                menuName = "建议及业务交流讨论";
            } else if (dataId == "SupplyList") {
                menuName = "供应清单";
            } else if (dataId == "WorkOrder") {
                menuName = "加工订单";
            } else if (dataId == "FactoryBatchNeedPlan") {
                menuName = "加工厂批次需求计划";
            } else if (dataId == "RawMonthDemandPlan") {
                menuName = "原材料月度需求计划";
            } else if (dataId == "InOrder") {
                menuName = "原材料到货入库";
            } else if (dataId == "SampleOrder") {
                menuName = "原材料取样订单";
            } else if (dataId == "CarReport") {
                menuName = "车辆运输卸货统计";
            } else if (dataId == "OrderPack") {
                menuName = "订单打包";
            } else if (dataId == "RawMaterialStock") {
                menuName = "原材料库存";
            }
            ...
            if (flag) {
                ...
                $.nfinetab.scrollToTab(top.$('.menuTab.active'));
            }
            return false;
        },
        init: function () {
