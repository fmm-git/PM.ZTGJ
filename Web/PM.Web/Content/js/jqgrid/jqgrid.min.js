...
(function (factory) {
                ...
                if (i == _colNo) {
                    if ($("#gview_" + ts.p.id).width() > _used_width) {
                        if (tmpcm.autowidth == true || tmpcm.autowidth == undefined) {
                            _width = _width + $("#gview_" + ts.p.id).width() - _used_width - 22;
                        }
                    }
                }
    ...
    $.jgrid.extend({
        //Editing
        editRow: function (rowid, keys, oneditfunc, successfunc, url, extraparam, aftersavefunc, errorfunc, afterrestorefunc, iCol) {
            ...
            return this.each(function () {
                ...
                var $t = this, nm, tmp, editable, cnt = 0, focus = iCol, svr = {}, ind, cm, bfer,
                ...
                if (!rc[expanded]) {
                    ...
                    if ($(this).jqGrid("isNodeLoaded", this.p.data[position])) {
                        ...
                        if (this.p.treeGridModel === 'nested') {
                            ...
                            //$(this).jqGrid("setGridParam", { postData: { nodeid: id, parentid: rc[parent], n_level: rc[level] } });
                            $(this).jqGrid("setGridParam", { postData: { nodeid: id, parentid: rc[parent], n_level: rc[level], code: rc["code"] } });
                        }
                        $(this).trigger("reloadGrid");
                        rc[loaded] = true;
                        if (this.p.treeGridModel === 'nested') {
                            ...
                            $(this).jqGrid("setGridParam", { postData: { nodeid: '', parentid: '', n_level: '', code: '' } });
                        }
                    }
