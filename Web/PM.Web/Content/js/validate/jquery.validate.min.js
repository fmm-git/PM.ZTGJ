    ...
    c.extend(c.validator, {
        ...
        prototype: {
            ...
            elements: function () {
                var a = this,
                b = {};
                return c(this.currentForm).find("input, select, textarea").not(":submit, :reset, :image").not(this.settings.ignore).filter(function () {
                    !this.name &&
...
$(function () {
    ...
    jQuery.validator.addMethod("isPhone", function (value, element) {
        ...
        return this.optional(element) || (value.length==11 && tel.test(value));
    }, "请正确填写您的电话号码。");
    // 联系电话(手机/电话皆可)验证   
    ...
    jQuery.validator.addMethod("TelYZ", function (value, element) {
        var length = value.length;
        var tel = /^0\d{2,3}\d{7,8}$/;
        var mobile = /^[1][0-9]{10}$/;
        var J86 = /^((\+?86)|(\(\+86\)))([1][0-9]{10})$/
        return this.optional(element) || (length == 11 && tel.test(value)) || (length == 11 && mobile.test(value)) || (length == 14 && J86.test(value));
    }, "请输入11位手机号或者座机号");
});