...
{
    /// <summary>
    /// 实体类TbFlowNode。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("TbFlowNode")]
    [Serializable]
    public partial class TbFlowNode : Entity
    {
        #region Model
        private int _id;
        ...
        public class _
        {
            ...
            /// * 
            /// </summary>
            public readonly static Field All = new Field("*", "TbFlowNode");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field id = new Field("id", "TbFlowNode", "");
            /// <summary>
            /// 流程代码
            /// </summary>
            public readonly static Field FlowCode = new Field("FlowCode", "TbFlowNode", "流程代码");
            /// <summary>
            /// 流程节点代码
            /// </summary>
            public readonly static Field FlowNodeCode = new Field("FlowNodeCode", "TbFlowNode", "流程节点代码");
            /// <summary>
            /// 流程节点名称
            /// </summary>
            public readonly static Field FlowNodeName = new Field("FlowNodeName", "TbFlowNode", "流程节点名称");
            /// <summary>
            /// 汇签(0表示非汇签1表示汇签)
            /// </summary>
            public readonly static Field AllApproval = new Field("AllApproval", "TbFlowNode", "汇签(0表示非汇签1表示汇签)");
            /// <summary>
            /// 自由选人(0不能自由选人1允许自由选人)
            /// </summary>
            public readonly static Field FreeCandidates = new Field("FreeCandidates", "TbFlowNode", "自由选人(0不能自由选人1允许自由选人)");
            /// <summary>
            /// 允许加签(0不允许加签1允许加签)
            /// </summary>
            public readonly static Field AddSignature = new Field("AddSignature", "TbFlowNode", "允许加签(0不允许加签1允许加签)");
            /// <summary>
            /// 允许跳过（0不允许跳过1允许跳过)
            /// </summary>
            public readonly static Field AllowedSkip = new Field("AllowedSkip", "TbFlowNode", "允许跳过（0不允许跳过1允许跳过)");
            /// <summary>
            /// 限制天数(允许跳过时可设置)
            /// </summary>
            public readonly static Field LimitDay = new Field("LimitDay", "TbFlowNode", "限制天数(允许跳过时可设置)");
            /// <summary>
            /// 限制小时数(允许跳过时可设置)
            /// </summary>
            public readonly static Field LimitHour = new Field("LimitHour", "TbFlowNode", "限制小时数(允许跳过时可设置)");
            /// <summary>
            /// 限制分钟数(允许跳过时可设置)
            /// </summary>
            public readonly static Field LimitMinutes = new Field("LimitMinutes", "TbFlowNode", "限制分钟数(允许跳过时可设置)");
            /// <summary>
            /// 允许驳回(0不允许驳回1允许驳回)
            /// </summary>
            public readonly static Field AllowedRejected = new Field("AllowedRejected", "TbFlowNode", "允许驳回(0不允许驳回1允许驳回)");
            /// <summary>
            /// 自由驳回(0不允许自由驳回1允许自由驳回)
            /// </summary>
            public readonly static Field FreeRejected = new Field("FreeRejected", "TbFlowNode", "自由驳回(0不允许自由驳回1允许自由驳回)");
            /// <summary>
            /// 驳回到指定节点(不为空表示只能驳回到本节点)
            /// </summary>
            public readonly static Field RejectedToNodeCode = new Field("RejectedToNodeCode", "TbFlowNode", "驳回到指定节点(不为空表示只能驳回到本节点)");
            /// <summary>
            /// _0非空节点，1空节点
            /// </summary>
            public readonly static Field BlankNode = new Field("BlankNode", "TbFlowNode", "_0非空节点，1空节点");
            /// <summary>
            /// 流程事件
            /// </summary>
            public readonly static Field FlowNodeEvent = new Field("FlowNodeEvent", "TbFlowNode", "流程事件");
        }
        #endregion
    }
}