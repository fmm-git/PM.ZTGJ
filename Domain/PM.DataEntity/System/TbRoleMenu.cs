...
namespace PM.DataEntity
{
    ...
    [Table("TbRoleMenu")]
    [Serializable]
    public partial class TbRoleMenu : Entity
    {
        #region Model
		private int _ID;
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "TbRoleMenu");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field ID = new Field("ID", "TbRoleMenu", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field RoleCode = new Field("RoleCode", "TbRoleMenu", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field MenuCode = new Field("MenuCode", "TbRoleMenu", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field OperationExamination = new Field("OperationExamination", "TbRoleMenu", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field OperationView = new Field("OperationView", "TbRoleMenu", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field OperationAdd = new Field("OperationAdd", "TbRoleMenu", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field OperationEdit = new Field("OperationEdit", "TbRoleMenu", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field OperationDel = new Field("OperationDel", "TbRoleMenu", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field OperationOutput = new Field("OperationOutput", "TbRoleMenu", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field OperationOther1 = new Field("OperationOther1", "TbRoleMenu", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field OperationOther2 = new Field("OperationOther2", "TbRoleMenu", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field OperationOther3 = new Field("OperationOther3", "TbRoleMenu", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field OperationOther4 = new Field("OperationOther4", "TbRoleMenu", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field OperationOther5 = new Field("OperationOther5", "TbRoleMenu", "");
        }
        #endregion
	}
}