...
{
    /// <summary>
    /// 实体类TbPositionMenu。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("TbPositionMenu")]
    [Serializable]
    public partial class TbPositionMenu : Entity
    {
        #region Model
		private int _ID;
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "TbPositionMenu");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field ID = new Field("ID", "TbPositionMenu", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PositionCode = new Field("PositionCode", "TbPositionMenu", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field MenuCode = new Field("MenuCode", "TbPositionMenu", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field OperationExamination = new Field("OperationExamination", "TbPositionMenu", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field OperationView = new Field("OperationView", "TbPositionMenu", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field OperationAdd = new Field("OperationAdd", "TbPositionMenu", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field OperationEdit = new Field("OperationEdit", "TbPositionMenu", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field OperationDel = new Field("OperationDel", "TbPositionMenu", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field OperationOutput = new Field("OperationOutput", "TbPositionMenu", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field OperationOther1 = new Field("OperationOther1", "TbPositionMenu", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field OperationOther2 = new Field("OperationOther2", "TbPositionMenu", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field OperationOther3 = new Field("OperationOther3", "TbPositionMenu", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field OperationOther4 = new Field("OperationOther4", "TbPositionMenu", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field OperationOther5 = new Field("OperationOther5", "TbPositionMenu", "");
        }
        #endregion
	}
}